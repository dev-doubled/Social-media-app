...
function ReactionUI({ reactionContent }) {
  if (!reactionContent) {
    return (
      <div>
        <i
          className={cx("fa-light fa-thumbs-up", "like-icon")}
          style={{ padding: "6px 4px" }}
        ></i>
        <span className={cx("text")} style={{ padding: "6px 4px" }}>
          Like
        </span>
      </div>
    );
      ...
      return (
        <div>
          <i
            ...
            style={{ color: "#0566ff", fontSize: "18px", padding: "6px 4px" }}
          ></i>
          <span
            className={cx("text")}
            style={{ color: "#0566ff", fontWeight: "600", padding: "6px 4px" }}
          >
            Like
          </span>
        </div>
